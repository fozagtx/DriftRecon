...
export function HowCard() {
  return (
    <article className="relative flex h-full min-h-[20rem] w-full flex-col rounded-xl border border-border bg-card p-6 shadow-[0_18px_50px_-24px_rgb(0_0_0_/_0.55)] sm:min-h-[24rem] sm:p-8">
      ...
      <div className="relative mt-6 flex-1">
        ...
        <div className="how-stage how-stage-2 absolute inset-0 flex flex-col justify-center">
          ...
          <ul className="mt-4 flex flex-col gap-2 text-sm">
            {["Exception", "Related events", "Recommendation"].map((item, index) => (
              <li key={item} className="how-item border border-border px-3 py-2" style={{ "--how-delay": `${index * 140}ms` } as CSSProperties}>
                {item}
              </li>
            ))}
          </ul>
        ...
        <div className="how-stage how-stage-3 absolute inset-0 flex flex-col justify-center">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <span className="how-item inline-flex min-h-10 items-center border border-border px-3 text-sm text-muted-foreground" style={{ "--how-delay": "120ms" } as CSSProperties}>
              Reject
            </span>
            <span className="how-item inline-flex min-h-10 items-center border border-border px-3 text-sm text-muted-foreground" style={{ "--how-delay": "240ms" } as CSSProperties}>
              Leave Unresolved
            </span>
          </div>
        </div>
